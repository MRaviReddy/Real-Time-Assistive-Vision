...
class lowlight_loader(Dataset):
    def __init__(self, lowlight_images_path, size=256):
        self.image_list = glob.glob(os.path.join(lowlight_images_path, "*.jpg"))
        random.shuffle(self.image_list)
        self.size = size
        print(f"Total training examples: {len(self.image_list)}")
